...
const TrucksPendingLoading = () => {
  return (
    <>
      <div className="dash">
        <div className="dashboard1">
          <FaListAlt
            style={{ marginLeft: -10, marginRight: 10,width:"35px",height:"35px" }}
          />
      ...
      <div className="info4">
        <div className="info5">
          <FaTruckMoving style={{ width: "30px",height:"30px",marginRight:"20px"}} />
          <h4>Сите возила</h4>
        </div>
        <BasicTable1 />
...
export default TrucksPendingLoading;
